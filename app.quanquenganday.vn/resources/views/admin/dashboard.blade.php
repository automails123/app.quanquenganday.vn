<x-app-layout>
    ...
    <div class="pb-10 md:py-12 container mx-auto max-md:mb-10 min-h-screen">
        <div class="md:flex md:gap-8 lg:gap-10">
            <div class="md:w-96 flex-shrink-0">
                <div
                    ...
                    <div class="md:space-y-4 max-md:grid max-md:grid-cols-2 max-md:gap-2">
                        <a href="{{route('admin.dashboard')}}"
                            class="flex items-center justify-between bg-black p-2 md:p-4 rounded-2xl text-white shadow-lg shadow-black/20">
                            <div class="flex items-center gap-1.5 md:gap-3">
                                ...
                                <div>
                                    <p class="font-bold max-md:text-sm">Dashboard quản trị</p>
                        ...
                        <a href="{{ route('admin.assign.index') }}"
                            class="flex items-center justify-between bg-gray-50 p-2 md:p-4 rounded-2xl border shadow-sm hover:bg-black transition group max-md:h-full">
                            <div class="flex items-center gap-1.5 md:gap-3">
                                <div
                                ...
                                <div>
                                    <p class="max-md:text-sm font-bold text-gray-900 group-hover:text-white">Gắn phường cho user</p>
                        ...
                        <a href="{{ route('admin.notifications.create') }}"
                            class="flex items-center justify-between bg-gray-50 p-2 md:p-4 rounded-2xl border shadow-sm hover:bg-black transition group">
                            <div class="flex items-center gap-1.5 md:gap-3">
                                <div
                                    class="w-10 h-10 bg-gray-100 rounded-xl flex items-center justify-center text-gray-500">
                                ...
                                <div>
                                    <p class="max-md:text-sm font-bold text-gray-900 group-hover:text-white">Tạo thông báo</p>
                        ...
                        <a href="{{ route('admin.shops.index') }}"
                            ...
                            <div class="flex items-center gap-1.5 md:gap-3">
                                ...
                                <div>
                                    <p class="max-md:text-sm font-bold text-gray-900 group-hover:text-white">Danh sách quán</p>
                        ...
                        <a href="{{ route('admin.users.index') }}"
                            ...
                            <div class="flex items-center gap-1.5 md:gap-3">
                                ...
                                <div>
                                    <p class="max-md:text-sm font-bold text-gray-900 group-hover:text-white">Danh sách user</p>
                        ...
                        <a href="{{ route('admin.orders.index') }}"
                            ...
                            <div class="flex items-center gap-1.5 md:gap-3">
                                ...
                                <div>
                                    <p class="max-md:text-sm font-bold text-gray-900 group-hover:text-white ">Duyệt đơn hàng</p>
                        ...
                        <a href="{{ route('admin.cccd.index') }}"
                            ...
                            <div class="flex items-center gap-1.5 md:gap-3">
                                ...
                                <div>
                                    <p class="max-md:text-sm font-bold text-gray-900 group-hover:text-white ">Xác minh tài khoản</p>
                        ...
                        <a href="{{ route('admin.commissions.index') }}"
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="max-md:text-sm font-bold text-gray-900 group-hover:text-white ">Hoa hồng & số dư</p>
            ...
            <div class="flex-1">
                <div class="bg-white overflow-hidden shadow-sm md:shadow-lg round-2xl md:rounded-2xl px-4 pb-10 md:p-5 lg:p-7 h-full">
                    <div class="mb-8">
                    ...
                    <div class="grid grid-cols-2 gap-4 md:gap-8">
                        <div class="bg-white p-6 rounded-[2rem] shadow-sm border ">
                            ...
                            <h2 class="text-2xl md:text-3xl font-black text-gray-900 my-1">{{ number_format($totalUser) }}</h2>
                        ...
                        <div class="bg-white p-6 rounded-[2rem] shadow-sm border ">
                            ...
                            <h2 class="text-2xl md:text-3xl font-black text-gray-900 my-1">{{ $totalShop }}</h2>
                        ...
                        <div class="bg-white p-6 rounded-[2rem] shadow-sm border ">
                            ...
                            <h2 class="text-2xl md:text-3xl font-black text-gray-900 my-1 ">{{ $pendingShops }}</h2>
                        ...
                        <div class="bg-white p-6 rounded-[2rem] shadow-sm border ">
                            ...
                            <h2 class="text-2xl md:text-3xl font-black text-gray-900 my-1">
